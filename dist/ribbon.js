...
define(["require", "exports", "knockout", "underscore", "jquery", "koutils/utils", "./slider"], function(require, exports, ko, _, $, utils, _slider) {
    ...
    var Ribbon = (function () {
        ...
        Ribbon.prototype.selectPage = function (page) {
            ...
            if (_.isNumber(page)) {
                ...
                var title = page;
                page = this.pages.find(function (p) {
                    return ko.unwrap(p.title) === title;
                });
            }
        ...
        Ribbon.prototype.removeSpecialPages = function () {
            var _this = this;
            var isSelected = false, selected = this.selectedPage();

            var toremove = this.pages.filterMap(function (p, i) {
                if (p === selected)
                    isSelected = true;
